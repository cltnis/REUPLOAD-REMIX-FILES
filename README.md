# 32.11 TUTORIAL!
VIDEO TUTORIAL: https://www.youtube.com/watch?v=BEH5gZUyr0I

1. Download 32.11 via https://drive.google.com/file/d/1X-K3cyFsqswUorH-2REQEKuLwh5oaEh8/view (this has UEFN + others and has total of 85 GB, works perfectly with the gameserver)
2. once you download the 32.11-CL-38202817 + UEFN.7z, download 7-Zip (https://7-zip.org/) and extract the 32.11-CL-38202817 + UEFN.7z with 7-Zip by right clicking on 32.11-CL-38202817 + UEFN.7z, hover over 7-Zip, and then click "Extract Here"
...
4. then rename the 32.11.exe file to "FortniteClient-Win64-Shipping.exe"
5. then put that FortniteClient-Win64-Shipping.exe in 32.11-CL-38202817 + UEFN/FortniteGame/Binaries/Win64
6. when prompted to replace, click replace
7. then u should be good from there
8. then download Neonite by downloading "Neonite-main.zip"
...
26. if it doesn't crash OR if it says joinable your good
